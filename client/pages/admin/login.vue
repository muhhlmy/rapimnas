<template>
    <DesktopOnlyWrapper>
      <div class="relative h-screen w-full overflow-hidden">
        <img src="../../assets/bg.png" alt="Kadinova Logo" class="absolute top-0 left-0 w-full h-full object-cover z-0">
    
        <!-- Optional overlay to make text more readable -->
        <div
          class="absolute top-0 left-0 w-full h-full bg-opacity-50 z-10"
        ></div>
        ...
        >
          <div
            class="max-w-md w-full mx-auto bg-blue-100 backdrop-blur-lg rounded-lg shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] p-8"
          >
            <img
              src="../../assets/logo.png"
              alt="Kadinova Logo"
            ...
            />
            <h1 class="text-2xl md:text-2xl text-center font-bold text-black">
              Sign in to RAPIMNAS Admin
            </h1>
            <p class="text-center text-black mb-5">Silakan masuk menggunakan akun yang telah terdaftar</p>
  ...
  const loadGoogleScript = () => {
    ...
    script.onload = () => {
      window.google.accounts.id.initialize({
        client_id:
          `${config.public.GoogleClient}`, // ini masih hardcode client id rahma ya hehe
